  ...
  return (
    <div className={className}>
      <Alert className="bg-muted/50 backdrop-blur-sm">
        ...
        <AlertTitle>Legal Disclaimer for India</AlertTitle>
        <AlertDescription>
          ...
          <p className="text-sm text-muted-foreground mt-2">
            By using this service, you acknowledge that the operators assume no liability for any actions taken based on the information provided. For grievances, please contact our Grievance Officer at grievance@factchecker.example.com.
          </p>
        </AlertDescription>
      </Alert>
    </div>
